...
# ╔═╡ cf12b9d6-48e1-11ee-1a56-d3ad825ec382
begin
  using Pkg
...
# ╔═╡ 67a02427-cba7-4443-9639-eb4ceaaabaae
using PythonCall, Random, DataFrames, CondaPkg

# ╔═╡ c5ce7c8e-efa1-4a98-8f75-4df13889444c
begin
  Random.seed!(0)
  n = 100
  p = 3
...
# ╔═╡ 3b9f4f5e-192c-41d9-94df-e954ff67e0f3
let
...
# ╔═╡ 06b6bf0f-95cd-436d-9190-3e323699e5b9
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "0c40a6dfb8911710bd7fad9f643af61535e937a6"
